...
The application the user jumps to can only show patient provided within the context.
...
JWT Bearer Token to an authorization server (this can be the Nuts node or a
custom implementation).
With this access token the user jumps to the resource server. The resource server
posts the access token to its authorization server to retrieve the contents of
the access token.
   ...
   #. Retrieve the information from the access token: `rfc7662 <https://tools.ietf.org/html/rfc7662>`_
      ...
      .. code-block:: console
        ...
        $ curl --location --request POST 'localhost:1323/auth/token_introspection' \
          --header 'Content-Type: application/x-www-form-urlencoded' \
          --data-urlencode 'token=eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..a36F_bxNzdd-nlSLww77M1a1wNdcwixv6ze4JE3_4yqkGMn0q8wIziDC3t2uVNJ5oRtQwBpCJgQ71BzxQpVfRjjknstcKIWgyFGRA8YI8NnwOebHBb--O_mgJWWZjVJ-ji4JoEaTLCzKtxiXU7R09StBXoSnPY3fwznkjxk6CKpuWSoedqXFklpadGSVFM6bO082tVVcsFjNThAOrQu6VfBo38N7wiaGXHb81ETicg-BNuCC-im0oE9xRFHv3ufb0gqD_9hZ6KuHT16Kyd74pgkxa__fUZfRJfUQMPRhamJOo9Lqd7_-BKbJnhtrn-U7f7pFqLQTHgHbDugWzoJxjw'

          {
            "active": true,
            "aud": "63dda892-7d4d-4059-b3be-b73c9136e385",
            "exp": 1581610302,
            "iat": 1581609402,
...
#. The resource server shows the page within the client context from the access token
...
Specify the contents of the access token
